...
class _DiscussionPage extends State<DiscussionPage>  {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: DiscussionPage(), // Set DiscussionPage as the home screen
    );
  }
}
...
class _DiscussionPageState extends State<DiscussionPage> {
  ...
  List<Message> messages = [
    Message(sender: "Eyiniola Fagbemi", content: "Hello, this is a message.", timestamp: DateTime.now()),
    Message(sender: "Ismail Kewa", content: "This is another message.", timestamp: DateTime.now()),
    Message(sender: "Samuel Komaiya", content: "Sample content for a message.", timestamp: DateTime.now()),
  ];
  ...
  void addReply(int index, String replyContent) {
    setState(() {
      messages[index].replies = [
        ...messages[index].replies,
        Message(sender: "You", content: replyContent, timestamp: DateTime.now()),
      ];
    });
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Row(
                                children: [
                                  IconButton(
                                    icon: Icon(
                                      Icons.thumb_up,
                                      color: messages[index].isLiked ? Colors.blue : Colors.grey,
                                    ),
                                  ...
                                  IconButton(
                                    icon: Icon(
                                      Icons.thumb_down,
                                      color: messages[index].isDisliked ? Colors.red : Colors.grey,
                                    ),
                              ...
                              TextButton(
                                child: Text("Replies (${messages[index].replies.length})"),
